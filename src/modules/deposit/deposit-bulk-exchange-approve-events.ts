...
import type { DepositBulkExchangeApproveJobStatus } from "./deposit-bulk-exchange-approve-job.model";

type DepositBulkExchangeApproveEventPayload = {
  jobId: string;
...
export function subscribeDepositBulkExchangeApproveEvents(jobId: string, res: Response) {
  res.status(200);
...
export function emitDepositBulkExchangeApproveEvent(payload: DepositBulkExchangeApproveEventPayload) {
...
export function closeDepositBulkExchangeApproveEventStream(jobId: string) {
